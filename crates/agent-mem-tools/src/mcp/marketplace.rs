...
impl McpMarketplace {
    ...
    fn initialize_builtin_servers(&mut self) {
        ...
        .with_tags(vec!["filesystem".to_string(), "files".to_string(), "system".to_string()])
        ...
        self.servers.insert(filesystem_server.id.clone(), filesystem_server);
        ...
        .with_author("Anthropic".to_string())
        .with_tags(vec!["github".to_string(), "git".to_string(), "development".to_string()])
        .with_documentation_url("https://github.com/modelcontextprotocol/servers".to_string())
        .with_github_url("https://github.com/modelcontextprotocol/servers".to_string())
        ...
        let brave_search_server = McpServerListing::new(
            ...
            "Search".to_string(),
            "npx".to_string(),
            vec!["-y".to_string(), "@modelcontextprotocol/server-brave-search".to_string()],
        )
        .with_author("Anthropic".to_string())
        .with_tags(vec!["search".to_string(), "web".to_string(), "brave".to_string()])
        .with_documentation_url("https://github.com/modelcontextprotocol/servers".to_string())
        .with_github_url("https://github.com/modelcontextprotocol/servers".to_string())
        .with_requirements(vec!["Brave Search API key".to_string()]);
        
        self.servers.insert(brave_search_server.id.clone(), brave_search_server);
    }
    ...
    pub fn get_categories(&self) -> Vec<String> {
        let mut categories: Vec<String> = self.servers
            .values()
...
mod tests {
    ...
    fn test_server_listing_builder() {
        ...
        assert_eq!(server.tags, Some(vec!["test".to_string(), "example".to_string()]));
        assert_eq!(server.documentation_url, Some("https://example.com".to_string()));
    }
